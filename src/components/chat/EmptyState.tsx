...
export function EmptyState({ onPick }: { onPick: (text: string) => void }) {
  return (
    <div className="fade-in mx-auto flex w-full max-w-[680px] flex-1 flex-col justify-center gap-5 px-5 pb-20">
      <h1 className="font-display text-center text-[2.1rem] font-normal leading-tight text-primary sm:text-[2.5rem]">
        {greeting()}
      </h1>
